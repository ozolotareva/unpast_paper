...
docker cp /local/DESMOND2_data_simulated/simulated desmond2_eval_container_clustering2:/local/DESMOND2_data_simulated/
...
docker cp desmond2_eval_container_clustering2:/tmp/ ~/ENCORE_functions/clustering/
